...
return [
    ...
    'missing_unless' => 'Le champ :attribute ne doit pas être présent sauf si :other vaut :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Le :attribute indiqué est apparu dans une fuite de données. Choisissez-en un autre.',
    ],
    'present' => 'Le champ :attribute doit être présent.',
    'present_if' => 'Le champ :attribute doit être présent quand :other est :value.',
    'present_unless' => 'Le champ :attribute doit être présent sauf si :other vaut :values.',
